...
import transactions.TMException;
...
public class Example {
    ...
    public static void main(String[] args) throws TMException {
        ...
        print("R1");
        System.out.println();
        list1 = tm.addRegion("regions1", "pl5", "pl1", "pl3");
        print(list1); //[pl1, pl3, pl5]
        System.out.println();
        list1 = tm.addRegion("regions2", "pl4", "pl8", "pl6");
        print(list1);
        System.out.println();
        list1 = tm.addRegion("regions7", "pl4", "pl7", "pl7", "pl2");
        print(list1); //[pl2, pl7]
        System.out.println();
        list1 = tm.addCarrier("c4", "regions1", "regions7");
        print(list1);
        System.out.println();
        list1 = tm.addCarrier("c5", "regions2", "regions1", "regions7");
        print(list1);
        System.out.println();
        list1 = tm.addCarrier("c3", "regions2", "regions3", "regions2", "regions1");
        print(list1); //[reg1, reg2]
        System.out.println();
        System.out.println("The has getCarriersForRegion =>");
        System.out.println();
